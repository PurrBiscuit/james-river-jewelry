...
ADD CONSTRAINT FK_OrderDetailsOrderID
FOREIGN KEY (OrderID) REFERENCES ORDERS(OrderID);

ALTER TABLE ORDER_DETAILS
ADD CONSTRAINT FK_OrderDetailsProductID
FOREIGN KEY (ProductID) REFERENCES PRODUCTS(ProductID);
...
ADD CONSTRAINT FK_ProductPriceHistoryProductID
FOREIGN KEY (ProductID) REFERENCES PRODUCTS(ProductID);

ALTER TABLE PRODUCTS
ADD CONSTRAINT FK_ProductsProductTypeID
FOREIGN KEY (ProductTypeID) REFERENCES PRODUCT_TYPES(ProductTypeID);
